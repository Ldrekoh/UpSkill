    ...
    <main className="min-h-screen flex flex-col lg:flex-row items-stretch bg-surface">
      ...
      <section className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-primary items-center justify-center p-20">
        <div className="absolute inset-0 opacity-20 pointer-events-none">
          <div className="absolute top-[-10%] left-[-10%] w-150 h-150 rounded-full bg-secondary-container blur-[120px]" />
          <div className="absolute bottom-[-10%] right-[-10%] w-125 h-125 rounded-full bg-primary-container blur-[100px]" />
        </div>
