...
export default function NewSkillPage() {
  return (
    <main className="min-h-screen pt-28 pb-20 px-6 bg-surface-container-lowest/50">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="relative">
          ...
          {/* Note informative sous le formulaire */}
          <p className="mt-8 text-center text-xs text-outline font-medium px-10 leading-loose">
            ...
            collaborative session. The tokens will be transferred to your
            balance once the learner confirms the completion.
          </p>
        </section>
      </div>
    </main>
